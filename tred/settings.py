"""
Django settings for tred project.
...
SECRET_KEY = 'django-insecure-+3z0i=-a3+@1vpg@w$c8b#n@#tb-ekr048t0@kod8t9r5py#w^'
...
WSGI_APPLICATION = 'tred.wsgi.application'
